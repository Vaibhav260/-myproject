...
import 'package:myproject/Rooms/roominfo.dart';
 ...
 class _HomepageState extends State<Homepage> {
   List roomallocation = List.empty();
   String roomname = "";
   String topic = "";
   @override
   void initState() {
     super.initState();
     roomallocation = ["UN25", "DISEC"];
   }
   createToDo() {
     DocumentReference documentReference =
     FirebaseFirestore.instance.collection("roomallocation").doc(roomname);
   ...
   deleteTodo(item) {
     ...
     DocumentReference documentReference =
     FirebaseFirestore.instance.collection("roomallocation").doc(item);
   ...
   Widget build(BuildContext context) {
     return  Scaffold(
       ...
       body: StreamBuilder<QuerySnapshot>(
           stream:  FirebaseFirestore.instance.collection("roomallocation").snapshots(),
